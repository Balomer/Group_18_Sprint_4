...
Feature: As a user, I should be able to upload files and pictures as messages.
  ...
  Scenario: User should be able to upload multiple same format files at the same time with dragging to the upload files and images box.
    And User uploads three same format files with dragging to the upload files and images box
    And User clicks send button
    Then User should see the uploaded files as attachments under the related message
  ...
  Scenario: User should be able to upload multiple different format files one by one with dragging to the upload files and images box.
    And User uploads multiple different format files one by one with dragging to the upload files and images box
    And User clicks send button
    Then User should see the uploaded files as attachments under the related message
  ...
  Scenario: User should be able to allow a recipient to edit documents.
    And User uploads document with clicking the upload files and images box
    And User clicks send button
    And User logouts
